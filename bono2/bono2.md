# 遺伝子発現データベースの使い方 at AJACS千里

情報・システム研究機構 ライフサイエンス統合データベースセンター  
[坊農 秀雅](http://bonohu.jp/) bono@dbcls.rois.ac.jp  
2015年6月17日 大阪大学吹田キャンパス 


----

これは統合データベース講習会AJACS千里「遺伝子発現データベースの使い方」の資料です。 
...
とくに、需要の増している公共遺伝子発現データベースからデータを検索し取得してくる方法について詳しく説明、実習します。
...
- 公共の遺伝子発現データベースの使い方
     -  NCBI Gene Expression Omnibus（GEO）
	       - 【実習1】GEOを使って、興味ある実験データセットを検索する
     - AOEとEBI ArrayExpress
